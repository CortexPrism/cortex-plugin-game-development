...
const gamedev_manage_assetsTool: Tool = {
  ...
  execute: async (args, ctx) => {
    ...
    try {
      ...
      return ok('gamedev_manage_assets', { status: 'completed', result: 'stub' }, s);
    } catch (e) {
      return {
...
const gamedev_debug_physicsTool: Tool = {
  ...
  execute: async (args, ctx) => {
    ...
    try {
      ...
      return ok('gamedev_debug_physics', { status: 'completed', result: 'stub' }, s);
    } catch (e) {
      return {
...
const gamedev_analyticsTool: Tool = {
  ...
  execute: async (args, ctx) => {
    ...
    try {
      ...
      return ok('gamedev_analytics', { status: 'completed', result: 'stub' }, s);
    } catch (e) {
      return {
